...
export default function(tinyI18n, { transaction, wrapped_unhighlight_createElement }) {
  const { getWord, setLanguage, getLanguages, getCurrentLanguage } = tinyI18n

  return class ModalContent extends React.Component {
    state = {
          ...
          <Body>
            ...
            <div className={bodyPrefix + 'info'}>
              ...
              {argsList[index] &&
                ...
                wrapped_unhighlight_createElement(
                  'div',
