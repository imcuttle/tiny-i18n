...
const {styleUsable, isElementOf, createSingleElementView, singleView} = require('../utils')
...
export const Header = ({children, onClose/*onMinimize*/}) => (
    <div className={prefix + 'header'}>
        ...
        <div className={prefix + 'header-buttons'}>
            <span onClick={onClose} className={prefix + 'header-btn close-btn' }>×</span>
        </div>
    </div>
)
...
export const Sep = ({color, style}) => (
    <div className={prefix + 'sep'} style={{ backgroundColor: color, ...style }}/>
)
